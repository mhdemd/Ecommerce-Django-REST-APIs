    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_phone', models.CharField(max_length=50, verbose_name='Phone Number')),
                ...
                ('default', models.BooleanField(default=False, verbose_name='Set as default address?')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='UserBase')),
            ],
            options={
